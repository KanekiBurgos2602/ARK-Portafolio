...
const datos = {
  lenguajes: [
    { nombre: 'C#', tiempo: '2 años', nivel: 'exp-2' },
    { nombre: 'PHP', tiempo: '2 años', nivel: 'exp-2' },
    { nombre: 'Python', tiempo: '1 año', nivel: 'exp-1' },
  ...
  basesDatos: [
    ...
    { nombre: 'DBeaber', tiempo: '1 año', nivel: 'exp-1' },
  ],
  herramientas: [
    { nombre: 'FastAPI', tiempo: '4 meses', nivel: 'exp-1' },
